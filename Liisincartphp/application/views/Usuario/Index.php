    ...
    <body>
        ...
        <div id="divIndex">
            <div class="hero-movil">
                ...
                <a type="button" href="<?= base_url() ?>Catalogo/cargarProductos" class="btn btn-primary btn-liisin">ver Productos</a>
            </div>
            ...
            <div class="abrir-cuenta">
                ...
                <div class="abrir-center">
                    <a href="<?= base_url() ?>ControladorCliente/redireccionar?pag=Usuario/register" class="btn btn-primary btn-liisin btn-abrir-cuenta btn-movil">Abrir una cuenta ahora</a>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
