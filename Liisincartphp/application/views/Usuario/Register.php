...
<html>
    ...
    <body>
        ...
        <div class="banner-top">
            <div class="container">
                <h1>Registro</h1> <em></em>
                <!--     <h2><a href="index.html">Home</a><label>/</label>Registro</a></h2>-->
            </div>
        </div>
        <script type="text/javascript">
            $(function () {
        ...
        <div class="container">
            <div class="register">
                <form method="POST" id="formRegistrar" name="formRegistrar" action="<?= base_url() ?>ControladorCliente/registrar1">
                    <div class="col-md-6 login-do">
                        <div class="login-mail">
                            <input type="text" placeholder="Nombre" required="" id="Nombre" name="Nombre"> <i class="glyphicon glyphicon-user"></i> </div>
                        <div class="login-mail">
                            <input type="text" placeholder="Celular" required="" name="telefono" id="telefono"> <i class="glyphicon glyphicon-phone"></i> </div>
                        <div class="login-mail">
                            <input type="text" placeholder="Email" required="" name="mail" id="mail"> <i class="glyphicon glyphicon-envelope"></i> </div>
                        <div class="login-mail">
                            <input type="password" placeholder="Contraseña" required="" name="pass" id="pass"> <i class="glyphicon glyphicon-lock"></i> </div>
                        <a class="news-letter " href="#">
                            <a href="#" class="olvidar">Olvidaste tu contraseña?</a>
                            <label class="checkbox1">
                                <input type="checkbox" name="checkbox"><i></i>Recordarme</label>
                        </a>
                        <button type="submit" class="btn btn-default btn-login hvr-skew-backward">Registrarse</button>
                    </div>
                    <div class="col-md-6 login-right">
                        ...
                        <div class="social-box">
                            <div class="row mg-btm">
                                <div class="col-md-8">
                                    <a href="#" class="btn btn-primary btn-block"> <i class="fa fa-facebook"></i>Login with Facebook</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
                                    <a href="#" class="btn btn-info btn-block"> <i class="fa fa-twitter"></i>Login with Twitter </a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
                                    <a href="#" class="btn btn-danger btn-block"> <i class="fa fa-google"></i>Login with Google </a>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"> </div>
