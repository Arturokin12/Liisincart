    ...
    <body>
        ...
        <div class="banner-top">
            <div class="container">
                <h1>Contáctanos</h1>
                <em></em>
                <h2><a href="<?php echo rtrim(base_url(), "/") ?>">Home</a><label>/</label><a href="#">Contacto</a></h2>
            </div>
        </div>
        <div class="contact">
            ...
            <div class="contact-form">
                <div class="container">
                    ...
                    <div class="col-md-6 contact-top">
                        ...
                        <form method="POST" action="<?=  base_url()?>ControladorCliente/contactar">
                            <div>
                                <span>Nombre</span>
                                <input type="text" id="txtNombre" name="txtNombre" value="" required="true">
                            </div>
                            <div>
                                <span>Email</span>
                                <input type="text" value="" id="txtMail" name="txtMail" required="true">
                            </div>
                            <div>
                                <span>Asunto</span>
                                <input type="text" value="" id="txtAsunto" name="txtAsunto" required="true">
                            </div>
                            <div>
                                <span>Mensaje</span>
                                <textarea id="txtMensaje" name="txtMensaje" required="true"> </textarea>
                            </div>
            ...
            <div class="map">
                <iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJZ5ZTHtvIBZERKdp7oIpTRU8&key=AIzaSyDSs4pPWlk3Bzx8wxOODEOMSkg8rs80Sp8" allowfullscreen></iframe>
            </div>
        </div>
        <!--abrir-cuenta-->
        <div class="abrir-cuenta">
            ...
            <div class="abrir-center">
                <a href="<?=  base_url()?>ControladorCliente/redireccionar?pag=Usuario/register" type="button" class="btn btn-primary btn-liisin btn-abrir-cuenta btn-movil">Abrir una cuenta ahora</a>
            </div>
            <div class="clearfix"></div>
        </div>
        <!--//abrir-cuenta-->
